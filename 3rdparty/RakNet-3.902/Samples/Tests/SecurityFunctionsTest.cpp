...
virtual void RakPeerInterface::AddToBanList  	(  	const char *   	 IP, 		RakNetTime  	milliseconds = 0	  	) 	
...
RakNet::RakString SecurityFunctionsTest::ErrorCodeToString(int errorCode)
{
