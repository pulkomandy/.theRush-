/*===============================================================================================
 ...
 Copyright (c), Firelight Technologies Pty, Ltd 2010-2015.
...
FMOD_RESULT F_CALLBACK eventcallback(FMOD_EVENT *event, FMOD_EVENT_CALLBACKTYPE type, void *param1, void *param2, void *userdata)
{
    ...
    {
        unsigned int user = (unsigned int)(intptr_t)userdata;
        unsigned int property = (unsigned int)(intptr_t)param1;
        float value = (float)(intptr_t)param2;

        printf("%p %s %f (%d)\n", event, property == FMOD_EVENTPROPERTY_VOLUME ? "volume" : FMOD_EVENTPROPERTY_PITCH ? "pitch" : "???", value, user);
    }
