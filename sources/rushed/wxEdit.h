...
public:
    ...
    wxZEdit(wxWindow* parent, wxAuiManager* mgr = NULL, wxZEditHandler *aHandler = NULL);
    ...
    // text edit
    void AddTextEdit(const wxString &Lib, tstring* pValue, unsigned int aID = 2)
    {
    ...
    // file
    void AddFileOpener(const wxString &Lib, const wxString & aExtensions, tstring *pValue, unsigned int aID = 2)
    {
    ...
    // directory
    void AddDirectoryChooser(const wxString &Lib, tstring *pValue, unsigned int aID = 2)
    {
