...
public:
		...
		: wxPanel(parent, -1, wxDefaultPosition, wxDefaultSize, wxNO_BORDER)
	{
		wxSizer *mSizer = new wxBoxSizer(wxHORIZONTAL);
		mID = aID;
		mTxt = new wxTextCtrl(this, 3, "", wxDefaultPosition, wxDefaultSize, wxTE_LEFT);
		mTxt->SetBackgroundColour(wxColour(197, 197, 197));
...
public:
		...
		: wxPanel(parent, -1, wxDefaultPosition, wxDefaultSize, wxNO_BORDER)
	{
		...
		mBox = new wxComboBox(this, 2, "", wxDefaultPosition, wxDefaultSize, mArray, wxCB_READONLY);
		if (mArray.GetCount())
...
public:
		...
		: wxPanel(parent, -1, wxDefaultPosition, wxDefaultSize, wxNO_BORDER)
	{
		...
		mBox = new wxRadioBox(this, 2, "", wxDefaultPosition, wxDefaultSize, mArray, 1, wxRA_SPECIFY_COLS);
...
private:
	...
	{
		wxFileDialog fDialog(GetParent(), "Choose a file", "", "", mExtensions,
