                     ...
                     : wxSashLayoutWindow(parent, -1, wxDefaultPosition, wxDefaultSize, wxNO_BORDER)
{
		...
		mDeleteLink = new wxButton(mPanel, wxID_ANY, "X", wxDefaultPosition, wxDefaultSize, wxALIGN_LEFT);
		...
		mLib = new wxStaticText(mPanel, wxID_ANY, "", wxDefaultPosition, wxDefaultSize, wxALIGN_LEFT);
...
void wxScriptEditPanel::SetScriptToEdit(const char *szName, wxString* pCode)
{
	if (!pCode)
	{
