...
/*
	...
	wxGraphNode *GetNodeByName(const char *szName);
	...
	void FillCodesFromNodeList(std::vector<wxString>& mList, GraphNodeType type, const char *szSubItem = "");
	...
	void ReadString(const char *pszFileName);
	...
	int GetNodeIndexByName(const char *szName);
...
*/
	...
	tstring mStateEnumBase, mMessageEnumBase;
